...
silent only
silent tabonly
cd ~/Documents/Development/pirates/src
...
badd +13 lib/Sidebar.svelte
badd +9 routes/__layout.svelte
...
tabnext
edit ~/Documents/Development/pirates/src/routes/index.svelte
argglobal
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
...
normal! 010|
tabnext
edit ~/Documents/Development/pirates/src/routes/discover.svelte
argglobal
balt ~/Documents/Development/pirates/src/routes/index.svelte
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
...
normal! 08|
tabnext
edit ~/Documents/Development/pirates/src/lib/Sidebar.svelte
argglobal
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
...
normal! 0
tabnext
edit ~/Documents/Development/pirates/src/lib/Pagination.svelte
argglobal
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
...
argglobal
balt ~/Documents/Development/pirates/src/lib/GameGrid.svelte
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
...
silent! normal! zE
let &fdl = &fdl
let s:l = 57 - ((0 * winheight(0) + 32) / 65)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 57
...
silent! normal! zE
let &fdl = &fdl
let s:l = 61 - ((0 * winheight(0) + 32) / 65)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 61
...
lcd ~/Documents/Development/pirates/src
tabnext
edit ~/Documents/Development/pirates/src/lib/GameCard.svelte
argglobal
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
...
argglobal
balt ~/Documents/Development/pirates/src/lib/GameCard.svelte
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
...
argglobal
balt ~/Documents/Development/pirates/src/lib/Header.svelte
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
...
normal! 0
tabnext
edit ~/Documents/Development/pirates/src/routes/about.svelte
argglobal
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
